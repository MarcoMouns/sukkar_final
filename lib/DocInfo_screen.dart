          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(allTranslations.text("aboutDoctor"),style: TextStyle(color: Colors.blue,fontSize: 20),),
                  Container(
                  ...
                  Text(allTranslations.text("doctorSpecailty"),style: TextStyle(color: Colors.blue,fontSize: 20),),
                  Container(
                    margin: EdgeInsets.only(right: 5),
                  ...
                  Text(allTranslations.text("workinghistory"),style: TextStyle(color: Colors.blue,fontSize: 20),),
                  Container(
                    margin: EdgeInsets.only(right: 5),
                  ...
                  Text(allTranslations.text("workingsince"),style: TextStyle(color: Colors.blue,fontSize: 20),),
                  Container(
                    margin: EdgeInsets.only(right: 5),
                  ...
                  Text(allTranslations.text("joinData"),style: TextStyle(color: Colors.blue,fontSize: 20),),
                  Container(
                    margin: EdgeInsets.only(right: 5),
