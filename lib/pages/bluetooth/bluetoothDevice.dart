...
//         resultTime = time;
//         resultData = data;
//         resultTestKind ="Blood Glucose"; //Urine Glucose OR Blood Glucose OR Uric Acid OR Total Cholesterol
...
//       tmpVal = (((tmpHVal.toDouble()) + (tmpLval.toDouble() / 256.0)) /100.0); //القياس عالي وال مرتفع

//       tmpIVal = tmpLval; //((tmpHVal * 256) + tmpLval);//القياس عالي وال مرتفع
//       tmpYear += 2000;
//       time = ((((tmpYear.toString() + "-") + tmpMonth.toString()) + "-") + tmpDay.toString() + " ");
//       if (tmpHour < 10) {
//         time = (time + "0");
//       }
//       time = ((time + tmpHour.toString()) + ":");
...
//           } else {
//             data =
//                 tmpVal.toString() + " " + units.toLowerCase() + " Normal";
//           }
//         }
//       } else {
//         if (typeStr == "1") {
...
//             if (tmpIVal >= 600) {
//               data =
//                   tmpIVal.toString() + " " + units.toLowerCase() + " Hi";
//             } else {
//               data =
...
//             if (tmpIVal <= 103) {
//               data =
//                   tmpIVal.toString() + " " + units.toLowerCase() + " Lo";
//             } else {
//               if (tmpIVal >= 413) {
//                 data =
//                     tmpIVal.toString() + " " + units.toLowerCase() + " Hi";
...
//         title: new Text((deviceState.toString().split('.')[1]=="connected") ? 
//         allTranslations.text("glucose meter connected") : allTranslations.text("glucose meter disconnected") ,
//         style:(deviceState.toString().split('.')[1]=="connected") ? 
//         TextStyle(color: Colors.green) : TextStyle(color: Colors.red) ,
//         ),
