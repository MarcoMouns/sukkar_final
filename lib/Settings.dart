...
import './pages/others/notification.dart';
...
class Settings {
  ...
  static Widget appBar({Widget title, BuildContext context}) {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextFormField(
        ...
        controller:
            widget.controller, //onFieldSubmitted: widget.onFieldSubmitted,
        decoration:
            new InputDecoration(labelText: allTranslations.text(widget.name)),
        keyboardType: widget.keyboard, textInputAction: TextInputAction.done,
...
class CustomBottomNavigationBarState extends State<CustomBottomNavigationBar> {
  ...
  @override
  Widget build(BuildContext context) {
    double bottomNavigationHeight = 65;
    try {
